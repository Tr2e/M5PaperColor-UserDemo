#!/usr/bin/env python3
"""Sanitized photo, RGB565 and home-adapter checks for warm-ratio candidate."""
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="papercolor-warm-ratio-tests-") as directory:
