#!/usr/bin/env python3
"""Sanitized calibrated-photo and real home-adapter checks with Burkes selected."""
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="papercolor-burkes-tests-") as directory:
        ...
        print("sanitized photo pipeline, both kernels and RGB565 inputs: pass", flush=True)
        ...
        print("sanitized Burkes viewer/home-region equivalence: pass", flush=True)
