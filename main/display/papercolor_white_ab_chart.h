...
namespace papercolor_white_ab_chart {
...
constexpr int IDS[]={16,17,20,10,19,22};
constexpr const char* LABELS[]={"16 MAGENTA  255,0,255","17 LIGHT PURPLE  153,51,204",
    "20 CYAN  0,255,255","10 BLUE CYAN  0,173,254",
